...
Renderer::Renderer(Window& parent) : OGLRenderer(parent) {
	...
	sphere = Mesh::LoadFromMeshFile("Sphere.msg");
	...
	camera = new Camera(-45, 0.0f, heightMapSize * Vector3(0.5f, 5.0f, 0.5f));
	...
	combineShader = new Shader("combinevertex.glsl",
		"combinefragment.glsl");
